'use strict';
 ...
 rpgApp.run([
	...
	function(Restangular) {
	    ...
	    Restangular.addFullRequestInterceptor(function(element, operation,
		    what, url, headers, query) {
		/*
		 * if ((what == 'geolocalizacao') || (what == 'abransind') ||
		 * (what == 'parametro') ) return {httpConfig:{cache:true}};
		 * return;
		 */
	    });
...
rpgApp.factory('Perfil', [ 'Restangular', function(Restangular) {
    return Restangular.service('perfil');
} ]);
